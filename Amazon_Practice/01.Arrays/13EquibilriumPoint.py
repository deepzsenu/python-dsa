"""_summary_
asy Accuracy: 49.32% Submissions: 100k+ Points: 2
Lamp
...
which takes the array and n as input parameters and returns
the point of equilibrium. Return -1 if no such point exists.
