...
Easy Accuracy: 47.96% Submissions: 56903 Points: 2
...
indexing).
Your Task:
The task is to complete the function findFloor() 
which returns an integer denoting the index value of K or return -1
