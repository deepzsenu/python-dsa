...
Medium Accuracy: 49.91 Submissions: 30287 Points: 4
...
are 2.
Your Task:
The task is to complete the function countOccurence() which returns count 
of elements with more than n/k times appearance.
    ...
    def countOccurence(self,arr,n,k):
        ...
        for keys in counts:
            if counts[keys] >j:
                s+=1
        return s
"""Different approach but the above one is efficient"""   
class Solution:
